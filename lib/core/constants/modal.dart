class ConstantsModal {
  static ConstantsModalImages get images => ConstantsModalImages();
}

class ConstantsModalImages {
  String get heightModalImage => 'lib/assets/height_modal_image.png';
